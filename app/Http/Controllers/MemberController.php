        ...
        if($members->count() > 0){
            ...
            foreach($members as $key =>  $item){
                $output .= '<tr>
                        ...
                        $output .= '<form action="" method="GET" style="display:inline;"><input class="toogle" type="checkbox" checked data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="mini"></form>';
